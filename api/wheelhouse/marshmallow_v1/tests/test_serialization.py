...
from marshmallow_v1.exceptions import MarshallingError
from marshmallow_v1.compat import total_seconds, text_type, basestring
...
class TestMarshaller:
    ...
    def test_default_to_missing(self):
        ...
        marshal = fields.Marshaller()
        res = marshal(
            u, {"name": fields.String(), "email": fields.Email(default=fields.missing)}
        )
