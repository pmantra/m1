...
QUERY = f"""
UPDATE reimbursement_organization_settings_allowed_category
SET currency_code = "USD"
WHERE benefit_type = "{BenefitTypes.CURRENCY.value}"
...
def backfill_currency_code():  # type: ignore[no-untyped-def] # Function is missing a return type annotation
