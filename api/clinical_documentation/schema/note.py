...
class PostAppointmentNoteSchemaV3(MavenSchemaV3):
    id = IntegerWithDefaultV3(dump_default=None, required=False)
    appointment_id = IntegerWithDefaultV3(dump_default=None, required=False)
    created_at = MavenDateTimeV3(dump_default=None, required=False)
    content = StringWithDefaultV3(dump_default="", required=False)
    draft = BooleanWithDefault(dump_default=None, required=False)
    modified_at = MavenDateTimeV3(dump_default=None, required=False)
    message_id = IntegerWithDefaultV3(dump_default=None, required=False)


class GetPostAppointmentNotesResponseSchemaV3(MavenSchemaV3):
    post_appointment_notes = fields.List(
        fields.Nested(PostAppointmentNoteSchemaV3), required=False
    )
...
class GetStructuredInternalNoteRequestSchemaV3(MavenSchemaV3):
