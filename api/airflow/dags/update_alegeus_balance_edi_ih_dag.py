...
with models.DAG(
    dag_id="update_alegeus_balance_edi_ih_dag",
    params={
        "team_ns": "benefits_experience",
        "service_ns": "wallet",
        "year": Param(2025, type="integer", minimum=2025),
        "dry_run": Param(False, type="boolean"),
        "wallet_ids": Param(None, type=["array", "null"]),
        "ros_ids": Param(None, type=["array", "null"]),
    },
    schedule="0 0 1 1 *",
    catchup=False,
    start_date=datetime(2024, 11, 1),
    tags=["benefits_experience", "wallet", "in_mono"],
    on_success_callback=dag_success_callback,
    on_failure_callback=dag_failure_callback,
) as dag:
    task_id = "update_alegeus_balance_edi_ih_job"
    ...
    kpo_task = KubernetesPodOperator(
        ...
        cmds=[
            "python3",
            "-c",
            "from airflow.scripts.benefits_experience.update_alegeus_balance_edi_ih import process_balance_update_job; process_balance_update_job(year={{ params.year }}, dry_run={{ params.dry_run }}, wallet_ids={{ params.wallet_ids }}, ros_ids={{ params.ros_ids }})",
        ],
        retries=2,
