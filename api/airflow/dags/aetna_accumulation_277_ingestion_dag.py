...
with models.DAG(
    dag_id="aetna_accumulation_277_ingestion_dag",
    params={"team_ns": "payments_platform", "service_ns": "payer_accumulation"},
    schedule="0 18 * * *",
    catchup=False,
    ...
    task_id = "aetna_accumulation_277_ingestion_job"
    ...
    kpo_task = KubernetesPodOperator(
        ...
        cmds=[
            "python3",
            "-c",
            "from airflow.scripts.payments_platform.aetna_accumulation_ingestion import aetna_accumulation_277_ingestion_job; aetna_accumulation_277_ingestion_job()",
        ],
        retries=2,
