...
with models.DAG(
    dag_id="memorystore_connection_test_dag",
    ...
    task_id = "memorystore_connection_test_job"
    ...
    kpo_task = KubernetesPodOperator(
        ...
        cmds=[
            "python3",
            "-c",
            "from airflow.scripts.core_service_team.memorystore_connection_test import memorystore_connection_test_job; memorystore_connection_test_job()",
        ],
        retries=2,
