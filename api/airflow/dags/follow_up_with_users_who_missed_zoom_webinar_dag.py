...
with models.DAG(
    dag_id="follow_up_with_users_who_missed_zoom_webinar_dag",
    params={"team_ns": "content_and_community", "service_ns": "content_campaigns"},
    schedule="30 4 * * *",
    catchup=False,
    start_date=datetime(2024, 3, 31),
    tags=["content_and_community", "content_campaigns", "in_mono"],
    on_success_callback=dag_success_callback,
    on_failure_callback=dag_failure_callback,
) as dag:
    task_id = "follow_up_with_users_who_missed_zoom_webinar_job"
    ...
    kpo_task = KubernetesPodOperator(
        ...
        cmds=[
            "python3",
            "-c",
            "from airflow.scripts.content_and_community.follow_up_with_users_who_missed_zoom_webinar import follow_up_with_users_who_missed_zoom_webinar_job; follow_up_with_users_who_missed_zoom_webinar_job()",
        ],
        retries=2,
