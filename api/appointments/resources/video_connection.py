...
from appointments.schemas.appointment_connection import (
    AppointmentConnectionClientInfo,
    AppointmentConnectionResponse,
)
...
class AppointmentConnectionResource(AuthenticatedResource):
    ...
    def post(self, appointment: Appointment):  # type: ignore[no-untyped-def] # Function is missing a return type annotation
        ...
        try:
            ...
            appointment_connection_client_info = AppointmentConnectionClientInfo(**data)
        ...
        log.info(
            "Retrieved client request data",
            user_id=user_id,
            appointment_id=appointment_id,
            client_info=appointment_connection_client_info,
        )
        ...
        resp = AppointmentConnectionResponse(
